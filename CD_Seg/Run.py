...
def train(arg, device):
    ...
    # 数据集加载
    traindata = TrainDataset(arg.data_path, 'Train2')
...
def main():
    ...
    parser.add_argument("--data_path", default='H:/zhuchuanhai/Data/SN7_2/')
    parser.add_argument("--bestmodel", default='H:/zhuchuanhai/CD_Seg/Out/SN7_HRNet/Model/Model_145.pth')
    parser.add_argument("--model_save_path", default='H:/zhuchuanhai/CD_Seg/Out/SN7_All_HRNet3/Model/')
    parser.add_argument("--log_dir", default='H:/zhuchuanhai/CD_Seg/Out/SN7_All_HRNet3/Log/')
