...
class EfficientNet_Unet4(nn.Module):
    def __init__(self, name='efficientnet-b0', pretrained=True, oc=2):
        super(EfficientNet_Unet4, self).__init__()
        ...
        self.last_layer = nn.Sequential(
            nn.Conv2d(
                ...
                stride=2,
                padding=1),
            nn.BatchNorm2d(decoder_filters[-5]),
            nn.ReLU(inplace=True),
            nn.Conv2d(
                in_channels=decoder_filters[-5],
                out_channels=decoder_filters[-5],
