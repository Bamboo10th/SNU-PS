...
img_name_list = file_name(r"H:\zhuchuanhai\PCD_SN7\Data\SN7\Test\HRNet_PCC_Pre")
img_np, label_np = get_img(img_name_list, r"H:\zhuchuanhai\PCD_SN7\Data\SN7\Test\HRNet_PCC_Pre",
