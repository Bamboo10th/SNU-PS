...
import Model.BIT.resnet as resnet0
...
class ResNet(torch.nn.Module):
    def __init__(self, input_nc, output_nc,
        ...
        if backbone == 'resnet18':
            self.resnet = resnet0.resnet18(pretrained=False,
                                           replace_stride_with_dilation=[False, True, True])
        elif backbone == 'resnet34':
            self.resnet = resnet0.resnet34(pretrained=True,
                                           replace_stride_with_dilation=[False, True, True])
        elif backbone == 'resnet50':
            self.resnet = resnet0.resnet50(pretrained=True,
                                           replace_stride_with_dilation=[False, True, True])
            expand = 4
        else:
